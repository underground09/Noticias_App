						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CustomersList-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"CustomersList-display": {
								"semanticObject": "CustomersList",
								"action": "display",
								"description": "Customers List App",
								"title": "Customers List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=customerslist",
									"url": sap.ui.require.toUrl("customerslist")
								}
							}
						}
					}
